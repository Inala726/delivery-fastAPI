...
@router.post("/", response_model=schemas.OrderResponse, operation_id="create_order")
...
@router.get("/", response_model=List[schemas.OrderResponse], operation_id="get_all_orders")
def get_all_orders(db: Session = Depends(get_db)):
    return db.query(models.Order).all()


@router.get("/{id}", response_model=schemas.OrderResponse, operation_id="get_order")
